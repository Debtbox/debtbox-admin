...
const Money = () => {
  ...
  const categoryData = [
    {
      name: t("money.categories.transactions", "Transactions"),
      value: 45,
      color: "#3b82f6",
    },
    { name: t("money.categories.fees", "Fees"), value: 30, color: "#10b981" },
    {
      name: t("money.categories.subscriptions", "Subscriptions"),
      value: 15,
      color: "#f59e0b",
    },
  ...
  const stats = [
    ...
    },
    {
      ...
      trend:
        ...
        revenueData[revenueData.length - 2].profit,
    },
    {
  ...
  const recentTransactions = [
    ...
    },
    {
      ...
      type: "subscription",
      description: t(
        "money.transactionTypes.subscription",
